...
from keras.layers.convolutional import Convolution2D, Deconvolution2D, AtrousConvolution2D, UpSampling2D, ZeroPadding2D
...
from layers.layers_densenetFCNtitu import SubPixelUpscaling
...
def __transition_up_block(ip, nb_filters, type='upsampling', weight_decay=1E-4):
    ...
    if type == 'upsampling':
        ...
        x = Convolution2D(nb_filters, (3, 3), activation="relu", padding='same',
...
def __create_fcn_dense_net(nb_classes, img_input, include_top, nb_dense_block=5, growth_rate=12,
    ...
    for block_idx in range(nb_dense_block):
        ...
        t = CropLayer2D(skip_list[block_idx])(t)

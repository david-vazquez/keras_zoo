...
batch_size_valid             = 4              # Batch size during validation
batch_size_test              = 4              # Batch size during testing
crop_size_train              = (512, 512) #(224, 224)      # Crop size during training (Height, Width) or None
crop_size_valid              = None            # Crop size during validation
crop_size_test               = None            # Crop size during testing
resize_train                 = (512, 1024) # (256, 512)      # Resize the image during training (Height, Width) or None
resize_valid                 = (512, 1024)      # Resize the image during validation
resize_test                  = (512, 1024)      # Resize the image during testing

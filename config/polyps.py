...
resize_train                 = (288, 384)      # Resize the image during training (Height, Width) or None
resize_valid                 = (288, 384)      # Resize the image during validation
resize_test                  = (288, 384)      # Resize the image during testing
